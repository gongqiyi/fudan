...
<div class="panel panel-default form-data">
    <div class="panel-body">
        ...
        <div class="tab-pane active" id="tab-category-base" role="tabpanel">
            ...
            echo $form->field($model, 'slug_rules')->textInput()->hint('格式：list/index?param1=0&amp;param2=2')?>
            <?= $form->field($model, 'slug_rules_detail')->textInput()->hint('格式：list/detail?param1=0&amp;param2=2')?>
        ...
        <div class="tab-pane" id="tab-category-config" role="tabpanel">
            ...
            <?php if(in_array(Yii::$app->request->get('id'),[1,50])):?>
                <div class="form-group">
                    <label class="col-sm-4 control-label">首页视频</label>
                    <div class="col-sm-17">
                        <div class="list-file clearfix j_upload_single_file">
                            <input type="hidden" class="upload_input" name="PrototypeCategoryModel[expand][index_video]" value='<?=isset($model->expand->index_video)?ArrayHelper::getValue($model->expand,'index_video'):''?>'>
                            <ul class="upload_list"></ul>
                            <a class="upload btn btn-default upload_btn" href="javascript:;">文件上传</a>
                        </div>
                    </div>
                </div>
            <?php endif;?>
            ...
            <?= $form->field($model, 'template_content')->textInput()?>
        </div>
