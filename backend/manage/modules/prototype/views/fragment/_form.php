...
<?= Html::a(Yii::t('common','Back List'), ['custom'], ['class' => 'btn btn-default j_goback']) ?>
<?php $this->endBlock(); ?>
        ...
        <div class="form-data-footer">
            <div class="form-group">
                <div class="col-sm-offset-4 col-sm-14">
                    ...
                    <?= Html::a(Yii::t('common','Back List').' <span class="st">&gt;</span>', ['custom'], ['class' => 'btn btn-link j_goback']) ?>
                </div>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
