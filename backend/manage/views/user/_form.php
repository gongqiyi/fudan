...
<div class="panel panel-default form-data">
    <div class="panel-body">
        ...
        <?php } ?>
        <?php $model->password = null;echo $form->field($model, 'password')->textInput() ?>

        <div class="form-group">
            <label class="col-sm-4 control-label">所属角色</label>
            <div class="col-sm-17">
                <?= Html::dropDownList('userRoles[]', ArrayHelper::getColumn($userRoles, 'role_id'), ArrayHelper::map($roleList, 'id', 'remark'),['class'=>'form-control','multiple'=>true,'prety'=>true,'data-placeholder'=>'请选择所属角色（多选）']) ?>
