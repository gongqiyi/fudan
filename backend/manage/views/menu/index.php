...
$this->title = ($group == 1?'前台':'后台').'菜单管理';

ListAsset::register($this);
$this->registerJs("listApp.init();", View::POS_READY);
?>
<?php $this->beginBlock('topButton'); ?>
<?= Html::a('新增菜单', ['create','group'=>$group], ['class' => 'btn btn-primary']) ?>
<?php $this->endBlock(); ?>
                ...
                foreach($dataList as $item){ ?>
                    <tr class="level_<?=$item['count']?>" <?php if($item['count'] > 1){echo 'style="display:none;"';}?>>
                        ...
                        <td class="opt" align="center">
                            <?= Html::a('添加子菜单', ['create', 'pid' => $item['id'],'group'=>$group], ['class' => 'text-primary']) ?>
...
<nav class="nav-operation clearfix">
    <div class="tools">
        ...
        <span>|</span>
        <?= Html::a(Yii::t('common','Batch sort'), ['sort'],['id'=>'j_sort_batch','data-pid'=>$pid?:0,'data-empty'=>empty($dataList)?1:0]) ?>
