...
<?php if($scope == 'custom'){ $this->beginBlock('topButton'); ?>
<?= Html::a('自定义配置管理', ['custom'], ['class' => 'btn btn-primary']) ?>
<?php $this->endBlock(); } ?>
<!-- 表单开始 -->
<div class="panel panel-default form-data">
    <div class="panel-body">
        ...
        <!-- 表单控件开始 -->
        <?php if(file_exists(Yii::$app->viewPath.'/'.Yii::$app->controller->id.'/_'.$scope.'.php')) echo $this->render('_'.$scope,['config'=>$config]);?>
        <?php
