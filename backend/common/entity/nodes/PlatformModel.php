...
/**
 * This is the model class for table "{{%node_platform}}".
 *
 * @property string $id
 ...
 */
class PlatformModel extends \common\components\BaseNodeModel
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'link', 'seo_title', 'seo_keywords'], 'string', 'max' => 100],
