...
/**
 * MemberSearch represents the model behind the search form about `common\entity\nodes\MemberModel`.
 */
class MemberSearch extends MemberModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'position', 'direction', 'thumb', 'atlas', 'description', 'content', 'attachment', 'template_content', 'seo_title', 'seo_keywords', 'seo_description'], 'safe'],
        ];
    }
