...
/**
 * This is the model class for table "{{%node_publish}}".
 *
 * @property string $id
 ...
 */
class PublishModel extends \common\components\BaseNodeModel
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'author', 'seo_title', 'seo_keywords'], 'string', 'max' => 100],
            [['publish', 'description'], 'string', 'max' => 255],
