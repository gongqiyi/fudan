...
class PrototypeCategorySearch extends PrototypeCategoryModel
{
    ...
    {
        return [
            [['id', 'pid', 'model_id', 'type', 'sort', 'status','site_id'], 'integer'],
            [['title','sub_title', 'slug_rules', 'slug','slug_rules_detail','layouts', 'link', 'thumb', 'content', 'template', 'template_content', 'seo_title', 'seo_keywords', 'seo_description'], 'safe'],
        ];
    }
