    ...
    <style>
        ...
        *:before {
        ...
        #wrap {
            ...
            width: 100%;
            height: 100%;
            background: #000 url(/uploads/dev-tip/bgPC.png) center/cover no-repeat;
        }
        .content{
            margin-left:auto;
            margin-right:auto;
        ...
        .logo{
            width:181px;
            height:46px;
            background:url(/uploads/dev-tip/logo.png) center/cover no-repeat;
        }
        .idea{
            margin-bottom: 30px;
        }
        ...
        @media screen and (max-width:767px) {
            #wrap {
                background: #000 url(/uploads/dev-tip/bgMobile.png) center/cover no-repeat;
            }
            .content{
                width:100%;
                padding-left:15px;
...
<div id="wrap">
    <div class="content">
        ...
        <article>
            ...
            <p class='text-right'><small>声明人/版权方</small></p>
            <p class='text-right'>上海稻壳网络科技有限公司</p>
        </article>
        <!--倒计时-->
        ...
        <!--logo-->
        <a href="http://www.doookay.com/" class="logo center-block" target="_blank"></a>
        <!--我们的口号-->
        <div class="idea text-center ">
            <p>致力于行之有效的互联网+解决方案</p>
            <p>INTENET MAKE IT HAPPEN</p>
        </div>
        <!--二维码-->
        <a href="javascript:;" class="code center-block ">
            <img src="/uploads/dev-tip/code.png " alt=" ">
        </a>
    </div> <!--content结束-->
</div> <!--wrap结束-->
<script>
