			...
			var _SELF = $(this),
				...
				object = function(length){
					...
					this.arrow = function(l,r,w,h,x,y){
						return "<em class=\"sPrev icon iconfont\" id=\"sPrev\" style=\"position:absolute;cursor:pointer;z-index:10;width:38px;height:38px;left:0;top:165px;border: 1px solid #dddcdc;border-radius: 50%;text-align: center;line-height: 38px\">&#xe601;</em><em class=\"sNext icon iconfont\" id=\"sNext\" style=\"position:absolute;cursor:pointer;z-index:10;width:38px;height:38px;right:0;top:165px;border: 1px solid #dddcdc;border-radius: 50%;text-align: center;line-height: 38px\">&#xe61b;</em>";
					};
